...
public class AttractionsPage {
    ...
    public static final Target SEARCH_BUTTON = Target.the("Search button").locatedBy("//span[text() = 'Buscar']");
    public static final Target RESULTS_TABLE = Target.the("Result table").locatedBy("//div[@data-testid = 'sr-list']");
