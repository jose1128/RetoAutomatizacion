...
public class ResultSearchDestinationPage {
    ...
    public static final Target RESERVE_NOW_HOTEL_BUTTON = Target.the("Reserve now hotel button").locatedBy("//span[contains(text(), 'Reserva ahora')]");
    ...
    public static final Target RESULTS_TABLE = Target.the("").located(By.id("search_results_table"));
